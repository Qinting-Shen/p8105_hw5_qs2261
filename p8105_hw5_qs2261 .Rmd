...
power_plot_df = 
  ...
  ggplot(aes(x = true_mean, y = props)) +
  geom_point() +
  labs(
...
#### Plot average estimate of mean and true mean
```{r}
plot_avg_mean= 
  ttest_result |> 
  group_by(true_mean) |> 
  ...
  geom_point()+
  labs(
    title = "Average estimate of mean",
...
plot_null_reject =  
  ...
  geom_point()+
  labs(
    title = "Average estimate of mean in null rejected samples",
    x = "True value of mean",
    y = "Average estimate of mean"
  )
